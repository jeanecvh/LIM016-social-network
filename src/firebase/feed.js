...
import { collection, addDoc, getDocs, onSnapshot, deleteDoc, doc, serverTimestamp, orderBy } from "https://www.gstatic.com/firebasejs/9.5.0/firebase-firestore.js"
...
export const orderByPost = () => query(collection(db, "post_user"), orderBy('timestamp'));
